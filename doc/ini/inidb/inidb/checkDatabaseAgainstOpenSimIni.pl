...
#
# checkDatabaseAgainstOpenSimIni 
# 
...
sub usage() {
	print "\n";
	print "Usage: checkDatabaseAgainstOpenSimIni INIFILE GRID\n\n";
	print "Checks a given INIFILE of a given GRID against the ini database and reports differences to the console\n";
